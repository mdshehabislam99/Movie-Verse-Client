  ...
  if (!movie) {
    return (
      <div className="min-h-screen bg-blue-900 flex items-center justify-center">
        <p className="text-amber-300 text-4xl font-bold">Movie prop is undefined or null</p>
      </div>
    );
  }
  return (
    <div>
      <div className="mx-auto p-13">
        <button
         ...
         text-red-500 font-bold text-3xl hover:text-amber-500
      ...
      from-pink-300 to-green-400 rounded-2xl overflow-hidden "
        >
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex  gap-2">
                  ...
                  backdrop-blur-lg rounded-full px-4 py-2 flex items-center space-x-2"
                  >
                ...
                <div className="flex flex-wrap gap-3">
                  {(movie?.cast ? movie.cast.split(",") : []).map(
                    (actor, index) => (
                      <span
                        key={index}
                        className="bg-gray-700/70 backdrop-blur-lg 
