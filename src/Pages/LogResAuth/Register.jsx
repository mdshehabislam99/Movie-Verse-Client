          ...
          <form className="flex gap-3 space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <button
                ...
                text-white font-semibold py-3 px-4 rounded-full transition 
              ...
              <button
                ...
                className="mt-4 w-full flex justify-center
                 items-center py-3 px-4 border border-gray-300
                  rounded-full
                   shadow-sm bg-gray-400 text-sm font-medium text-gray-700 hover:bg-amber-500 transition duration-200 disabled:opacity-50"
              >
              ...
              <div className="flex justify-between mt-4">
                ...
                <p className="text-blue-600 hover:text-amber-500 font-semibold">
